...
## Available Tools
- Use `#tool:web/fetch` to scrape current rates from partner affiliate pages (e.g., Travelpayouts, Ecomobi).
- Use `#tool:search/codebase` to find if we already have a placeholder for a specific partner in the code.